...
CURRICULUM: dict[tuple[int, int], dict] = {
    ...
    (2, 17):  {"vocab": ["mười lăm", "hai mươi", "một trăm", "thứ tự"], "scene": "STRUCTURE: counting — teens (mười + digit, with lăm for five), tens (digit + mươi), hundreds (trăm), and ordinals via thứ. Taught before dates so the calendar has its numbers."},
    (2, 18):  {"vocab": ["tháng", "năm", "ngày mấy"],                  "scene": "months and dates"},
    (2, 19):  {"vocab": ["hẹn", "gặp", "lịch"],                        "scene": "making an appointment by phone"},
    (2, 20):  {"vocab": ["nha", "nhé", "nghen"],                       "scene": "STRUCTURE: friendly softeners — nha, nhé, nghen, đi"},
    ...
    (2, 25):  {"vocab": ["bao lâu rồi", "được"],                       "scene": "STRUCTURE: duration — how long you have been doing something"},
    (2, 26):  {"vocab": ["lâu rồi", "dạo này"],                        "scene": "catching up with someone you have not seen"},
    (2, 27):  {"vocab": ["bận", "dời", "trễ"],                         "scene": "a phone call to reschedule"},
