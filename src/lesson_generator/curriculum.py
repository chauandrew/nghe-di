...
CURRICULUM: dict[tuple[int, int], dict] = {
    ...
    (4,  4):  {"vocab": ["nên", "phải", "cần"],                        "scene": "STRUCTURE: modality — nên (should), phải (must), cần (need); recombines known words"},
    (4,  5):  {"vocab": ["viên", "lần"],                              "scene": "at the pharmacy: dosage — uống mấy viên, mấy lần một ngày"},
    (4,  6):  {"vocab": ["có thể", "được không"],                     "scene": "STRUCTURE: ability & permission — có thể, ...được không (may I), cho"},
    ...
    (4,  9):  {"vocab": ["mưa", "nắng", "trời"],                       "scene": "planning around the weather (nếu trời mưa thì ...)"},
    ...
    (4, 13):  {"vocab": ["bị", "được"],                               "scene": "STRUCTURE: passive — bị (bad outcome) / được (good outcome) + verb"},
    (4, 14):  {"vocab": ["mất", "trộm", "bể"],                         "scene": "reporting something lost, stolen, or broken (bị mất, bị trộm)"},
    (4, 15):  {"vocab": ["máy lạnh", "nóng"],                          "scene": "hotel room problems (máy lạnh bị hư, không có nước nóng)"},
    ...
    (5, 22):  {"vocab": ["chứ", "đó"],                                "scene": "STRUCTURE: emphatic particles (southern) — chứ, đó; note the northern đấy/cơ you will also hear"},
